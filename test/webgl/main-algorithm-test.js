...
describe('Main algorithm', function () {
  ...
  it.skip('Performance test', function () {
    ...
    console.timeEnd('algorithm 3 rays') //3.43e+03ms
    console.time('algorithm 3 rays without webgl')
    mainAlgorithm(pointsToLabel, {NUMBER_OF_RAYS: 3, isWebgl: false})
    console.timeEnd('algorithm 3 rays without webgl') // 787 ms

    console.time('algorithm 128 rays')
    //mainAlgorithm(pointsToLabel, {NUMBER_OF_RAYS: 128, isWebgl: true})
